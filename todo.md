...
Nothing open. The eighth pass read the panel item against the laws of UX, and
every row of it was closed in the run of commits that follows it in the log,
along with the screenshots that had gone stale behind the menu's own changes.
